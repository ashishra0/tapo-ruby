...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/ashishra0/tapo-ruby'
  spec.license       = 'MIT'
  spec.required_ruby_version = '>= 2.7.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/ashishra0/tapo-ruby'
  spec.metadata['changelog_uri'] = 'https://github.com/ashishra0/tapo-ruby/blob/main/CHANGELOG.md'
